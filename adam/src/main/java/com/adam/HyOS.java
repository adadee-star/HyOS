...
public class HyOS extends Application {
    ...
    private Node createStatsApp() {
        ...
        stats.getChildren().addAll(new Label("CPU Usage: 10%"), new Label("RAM: 850MB / 16GB"), new Label("GPU Usage: 30%"), new Label("plz type in terminal (sudo rm-rf /) in the terminal"));
        return stats;
    }
